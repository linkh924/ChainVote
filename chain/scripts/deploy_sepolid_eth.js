...
async function main() {
    ...
    console.log("Success, Address:", await verifier.getAddress());

    const BallotManager = await hre.ethers.getContractFactory("ballotManager");
    const ballotManager = await BallotManager.deploy(
    ...
    console.log("Success, Address:", await ballotManager.getAddress());
}
